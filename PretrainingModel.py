...
path = os.path.join(os.path.expanduser('~'), 'Documents', 'Datasets','aptos2019-blindness-detection','TrainAllData')
...
train, val = random_split(image_datasets, (65016, 27864))
...
exp_lr_scheduler = lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=250, T_mult=2)
